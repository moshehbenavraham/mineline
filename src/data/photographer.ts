...
Whether working on editorial assignments or commercial projects, I strive to create images that transcend their immediate purpose and become lasting visual statements.`,
  ...
  availability: 'Currently booking for Q3 2026',
  // Social links default to undefined so the Footer / About / JSON-LD
  // sameAs render nothing until real handles are populated. Pointing at
  // fictional profile URLs (or worse, at instagram.com / linkedin.com home
  // pages) sends visitors nowhere useful and pollutes structured data.
  // To enable: replace `undefined` with the absolute profile URL, e.g.
  ...
  portraitImage: '/assets/portfolio/40-1585279968680-6606ee6ed134.jpg'
};
