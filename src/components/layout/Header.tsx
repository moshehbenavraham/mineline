                ...
                >
                  <Link
                    ...
                    className={cn(
                      ...
                      // Match the logo: white over the transparent home hero,
                      // semantic foreground everywhere else. Hardcoded
                      // text-white was invisible on non-home routes in light
                      // mode (white-on-near-white) — real visibility bug.
                      isTransparent
                        ? 'text-white hover:text-white/80'
                  ...
                  >
                    {link.name}
                    {/* Active underline — color tracks the link color */}
